      ...
      <div class="lp-nav-inner">
        <div class="lp-logo">
          <div class="lp-logo-icon">
            <svg viewBox="0 0 32 32" width="24" height="24" fill="none"><rect width="32" height="32" rx="8" fill="#6c5ce7"/><text x="16" y="23" text-anchor="middle" font-family="system-ui,sans-serif" font-size="18" font-weight="700" fill="white">ef</text></svg>
          </div>
